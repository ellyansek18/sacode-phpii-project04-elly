      ...
      <div class="row mt-5">
        <div class="col-6 m-auto p-5 rounded shadow border">
          <form>
            ...
            <div class="form-group mb-3">
              <div class="form-label text muted" for="alamat-email">Kata Sandi</div>
            ...
            <div class="form-group mb-3">
              ...
              <input type="password" id="kata-sandi" class="form-control form-control-lg py-3" placeholder="Kata Sandi">
              <small>
            ...
            <div class="mt-5 text-center">
              sudah punya akun? <a href="login.php" class="text-secondary">Login</a>
            </div>
